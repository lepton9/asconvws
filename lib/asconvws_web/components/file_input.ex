    ...
    <!-- Form -->
      <.form :let={f} for={@for} phx-submit="submit" phx-change="validate" multipart={@mode == :file}>
        ...
        <.button
          ...
          class="mt-2 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br transition-all shadow-md disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none px-4 py-2 rounded cursor-pointer"
        >
          Submit
        </.button>
      </.form>
